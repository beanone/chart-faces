...
@Component
public class MiddleBoxCalculatorImpl implements BoxCalculator {
	@Override
	public Box calculate(Box containerBox, IChartPart part) {
		...
		int x = (containerBox.getWidth()-width)/2;
		int y = (containerBox.getHeight()-height)/2;
		return new Box(x, y, width, height);
	}

	@Override
	public Object[] getIds() {
		return new Object[] {EnumPosition.bottom, EnumPosition.footer};
	}
