...
public class YAxisRangeProcessorTest {
	...
	public void testIsAxisRangeUndefinedAxisNoMinMax() {
		...
		final AxisRangeProcessor processor = (AxisRangeProcessor) AxisRangeProcessorMaker
				.makeYAxisRangeProcessor(new YAxis());
	...
	public void testProcessComponentRangeWithoutAxis() throws Exception {
		...
		processor.process();
		Assert.assertEquals(2.0, component.getYRange().getMin());
		Assert.assertEquals(30.0, component.getYRange().getMax());
	}
	...
	public void testProcessEmptyComponentRangeWithAxisWithMinMax()
		...
		processor.addComponent(component);
		processor.process();
		Assert.assertEquals(10.0, component.getYRange().getMin());
		Assert.assertEquals(50.0, component.getYRange().getMax());
	}
	...
	public void testStoreAxisRange() {
		...
		Assert.assertSame(component.getYRange(), range);
	}
}